...
public class RepairDTO {
    ...
    public RepairDTO(String RID, String CustomerID, String MobileName, String ReparFault, double RepairCost, String repDate, ArrayList<CustomerDTO> CustomerList) {
        this.RID = RID;
    ...
    public RepairDTO(String rid, String customerID, String mobileName, String reparFault, double repairCost, String repDate) {
         this.RID = rid;
        this.CustomerID = customerID;
        this.MobileName = mobileName;
        this.ReparFault = reparFault;
